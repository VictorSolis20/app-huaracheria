 ...
 * @author Victor
 */
public class MuestraDomicilioPersonal extends javax.swing.JPanel {
     ...
     */
    public MuestraDomicilioPersonal() {
        initComponents();
        LoadMuestraDomicilioPersonal();
    }

    public MuestraDomicilioPersonal(int numIdPersonal) {
        initComponents();
        idPersonal = numIdPersonal;
        LoadMuestraDomicilioPersonal();
    }

    private void LoadMuestraDomicilioPersonal() {
        try {
            DAODomicilioPersonal dao = new DAODomicilioPersonalImpl();
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            dao.listar(idPersonal).forEach((d) -> model.addRow(new Object[]{d.getIdDomicilio(), d.getEstado(), d.getMunicipio(), d.getColonia(), d.getCalle(), d.getNumeroExterior(), d.getIdPersonal(), d.getFechaRegistro()}));
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Estado", "Municipio", "Colonia", "Calle", "Número exterior", "ID_Personal"
            }
        ) {
        ...
        jLabel1.setText("Domicilios registrados del personal");
    ...
    private void nuevoBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nuevoBtnActionPerformed
        MenuPrincipal.ShowJPanel(new RegistroDomicilioPersonal(idPersonal));
